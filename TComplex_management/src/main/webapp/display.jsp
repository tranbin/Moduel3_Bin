...
<body>
<h1>List TCPLEX</h1>
<a href="/tcomplex?action=create">Create new Users</a></br>
<a href="/tcomplex?action=search">Search TComplex </a>
<table border="1" width="600px">
    ...
    <c:forEach var="tComplex" items="${tComplexList}">
        <tr>
            ...
            <td><a href="/tcomplex?action=delete&id=${tComplex.id}">Delete</a></td>
        </tr>
    </c:forEach>
</table>
</body>
